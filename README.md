...
## 更新履歴
### v0.1.6 (2019/03/13)
* 画像の配置座標計算をした後、空白を埋めるように補正  
![v016_main](https://github.com/degarashi/sprinkler/blob/images/sprinkler_v016.jpg)  
* 画像の再配置ボタンを追加  
* windows環境にてファイル列挙時にジャンクション、シンボリックリンクを弾けていなかった問題を修正  
* 循環ディレクトリを走査した際の無限ループを阻止  
### v0.1.5 (2019/02/02)
